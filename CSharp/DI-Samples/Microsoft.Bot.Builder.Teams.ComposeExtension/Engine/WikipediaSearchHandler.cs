...
using Microsoft.Bot.Builder.Teams.ComposeExtension.Engine.Models;
...
namespace Microsoft.Bot.Builder.Teams.ComposeExtension.Engine
{
    public class WikipediaSearchHandler : ISearchHandler
    {
        ...
        /// </summary>
        /// <param name="composeExtensionActivityAction">The compose extension activity action.</param>
        /// <returns></returns>
        public async Task<ComposeExtensionResult> GetSearchResultAsync(ComposeExtensionActivityAction composeExtensionActivityAction)
        {
            ...
            // Search Wikipedia
            string apiUrl = GenerateSearchAPIUrl(composeExtensionActivityAction.ComposeExtensionQuery);
